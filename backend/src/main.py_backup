    ...
    def get_state(self) -> dict:
        ...
        return {
            ...
            "rl": {
                ...
                "mode":            self.rl.mode,
                "api_key_set":     self.rl.get_status()["api_key_set"],
                "call_count":      self.rl.call_count,
                "call_errors":     self.rl.call_errors,
                "last_response":   self.rl.last_response,
                "last_latency_ms": self.rl.last_latency_ms,
            },
